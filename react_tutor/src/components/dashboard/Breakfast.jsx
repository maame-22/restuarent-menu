...
const Breakfast = () => {
  ...
  return (
      <div className='grid  grid-cols-5 min-h-screen relative  '>  
        <Sidebar className={`${open==true?'left-0' :'-left-500'}`}/>
        <div className='relative lg:ml-[230px] ml-[30px]  w-full col-span-5 lg:col-span-4'>
          <div className=' mb-[10px] mt-[15px] flex items-center '>
            
             <h1 className='w-full text-2xl md:text-3xl lg:text-5xl text-center '>Welcome To Breakfast</h1>
          </div>
            
          <div className='mt-[50px] mb-[100px]'>
            <div className='text-end w-[90%] mx-auto'>
             ...
             <div className='w-full overflow-y-scroll overflow-x-scroll mb-[100px]'> 
              <table className='mx-auto mt-[20px] table-auto' >
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>Name</th>
         ...
         {
          showModal &&(
            <div className='absolute top-[10%] md:top-[5%] right-[5%] md:right-[25%] bg-gray-200 w-[90%] md:w-[35%] min-h-[45vh] md:min-h-[60vh] rounded-md'>
              <div className='flex justify-between items-center p-[10px]'>
                <h1 className='text-2xl font-semibold'>Add Breakfast</h1>
